...
export default function Header() {
  ...
  return (
    <header>
      ...
      <img loading="lazy" width="250" height="98" alt="Dimaniyat Tours" title="Dimaniyat Tours" aria-label="Dimaniyat Tours" src={siteLogo} className="siteLogo" />
          </CustomLink>
        </ul> 
  ...
  <a className="off-canvas-overlay" href="#close"></a>
        ...
        <ul className="HomeMenu">
          ...
          <picture>
            ...
            <img loading="lazy" width="40" height="40" alt="Dimaniyat Tours | User Profile" title="Dimaniyat Tours | User Profile" src={User} className="icon-USER" />
          </picture>
          </CustomLink>
